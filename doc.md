...
| 我的 | `pages/profile/index` | 展示微信头像昵称、隐私设置、记录提醒入口、亲友资产入口、资产月报、资产健康分、返回我的资产 |
| 记录提醒 | `pages/reminder/index` | 设置每月几号提醒，默认当天 10:00 发送订阅通知 |
| 亲友资产 | `pages/family/index` | 生成分享码、输入分享码绑定亲友、展示家庭合计资产、展示绑定用户、切换亲友资产浏览模式 |
...
| `login` | 初始化或获取当前用户资料 |
| `workspace` | 获取完整工作区数据 |
| `profileUpdate` | 更新头像、昵称、隐私、暗黑模式、新功能引导状态、账户补录提醒关闭日期和目标参数 |

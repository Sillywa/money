...
- 亲友资产模式下，各资产页面及其进入的子页面需要保留正在查看亲友资产的提示，并在提示右侧提供“返回我的资产”；所有查询和修改都以当前亲友身份执行，只有点击“返回我的资产”后才切回自己的资产。
- 亲友浏览模式下底部仍展示资产总览、资产明细、资产目标三个原生 tabBar 入口，并将“我的”入口改为“返回我的”；点击后效果等同于顶部“返回我的资产”，切回登录用户自己的资产数据。
